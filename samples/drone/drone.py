...
class DroneDataset(utils.Dataset):
    ...
    def load_drone(self, dataset_dir, subset):
        ...
        for a in annotations:
            ...
            class_present = [n['class'] for n in objects]
            class_ids = [class_dict[c] for c in class_present]
...
def train(model):
    ...
    dataset_train.load_drone(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = DroneDataset()
    dataset_val.load_drone(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        class InferenceConfig(DroneConfig):
